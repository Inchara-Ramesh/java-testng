...
public class Activity9
{
  ...
  public void testcase8()
  {
     ...
     System.out.println("Title of the page : " + driver.getTitle());
	  ...
	  System.out.println("The first 5 name and user column are: ");
	  for(int i = 1; i < 10; i++)
	  {
		  System.out.println(driver.findElement(By.xpath("//table[@class='list view table-responsive']/tbody/tr[" + i +" ]/td[3]")).getText());
		  System.out.println(driver.findElement(By.xpath("//table[@class='list view table-responsive']/tbody/tr[" + i + "]/td[7]")).getText());
 	  }
  }
